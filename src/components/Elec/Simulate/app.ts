...
let componentsSizeInput = document.querySelector('#componentsSize') as HTMLInputElement
let bin = document.getElementById('bin')

//Variables utilisateur
let connections : Connection[] = [] //Liste des cables sur le schéma
let components : Component[] = [] //Liste de composants sur le schéma
let moving = false
