...
export class Moteur implements Récepteur{
    ...
    properties = () => [
        <ComponentProperty component={this} property="R" suffix="Ω" label="Résistance : " key={0}/>,
        <ComponentProperty component={this} property="P" suffix="W" readonly={true} label="Puissance : " key={1}/>,
    ];
}